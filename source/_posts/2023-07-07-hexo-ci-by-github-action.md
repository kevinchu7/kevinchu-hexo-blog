...
>
>这几个月的时间里我也积累了一些知识和经验，打算在接下来的博客中陆续记录下来，而今天还是用来了结一个想了许久没去做的事儿——回忆一下本博客的搭建流程。
>
...
在之前的博客中也介绍过PicGo这个软件，用它来上传图片到图床并获取对应的访问链接非常方便，参考这篇文章(https://blog.kevinchu.top/2021/02/15/tuchuang/)。
